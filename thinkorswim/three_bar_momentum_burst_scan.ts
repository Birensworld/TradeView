...
# through 2 days ago) are all green (close > open) with each closing higher
# than the one before it, and the close gained at least minGainPct% (default
# 3) from the 1st of those 3 to the 3rd (today).
#
...
plot scan = last3Green and ascendingCloses and bigGain;
